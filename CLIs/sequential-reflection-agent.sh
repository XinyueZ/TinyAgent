#!/bin/bash
# Run sequential-reflection-agent in Docker
#
# Usage (from anywhere on the host):
#   /app/CLIs/sequential-reflection-agent.sh --output <output_dir> --tasks <tasks_dir>
#
...
if ! command -v docker &>/dev/null; then
    ...
    exec python "${REPO_ROOT}/apps/sequential-reflection-agent/sequential-reflection-agent.py" "$@"
fi
