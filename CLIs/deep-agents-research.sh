#!/bin/bash
# Run deep-agents-research in Docker
#
# Usage (from anywhere on the host):
#   /app/CLIs/deep-agents-research.sh --output <output_dir> --tasks <tasks_dir>
#
...
if ! command -v docker &>/dev/null; then
    ...
    exec python "${REPO_ROOT}/apps/deep-agents-research/deep-research.py" "$@"
fi
